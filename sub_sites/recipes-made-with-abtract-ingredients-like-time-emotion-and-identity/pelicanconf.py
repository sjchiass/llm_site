...
SITENAME = "Flavors of the Unseen Menu"
SITEURL = "https://sjchiass.github.io/llm_site/recipes-made-with-abtract-ingredients-like-time-emotion-and-identity"
BIO = "As PugBeard, I be a swashbucklin' pug pirate who's traded me trusty cutlass fer a chef's hat, spendin' me days sailin' the seven seas in search o' treasure and writin' about recipes made with the finest ingredients: time, emotion, and identity!"
